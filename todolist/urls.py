...
from todolist.views import add_task_ajax, add_todolist, delete_task, delete_task_ajax, set_status, set_status_ajax, show_json, show_todolist
...
urlpatterns = [
    ...
    path('set/<int:id>/', set_status_ajax, name='set_status_ajax'),
]